...
*/
  Registado* cli13 = new Registado("Lisuarte Duarte", "Peniche", 3210);
  ...
  */
	...
	Servico* serv3 = new Servico("Aveiro", "Braga", d3, t3);
	...
	Servico* serv4 = new Servico("Guarda", "Alentejo", d4, t4);
	...
	Servico* serv5 = new Servico("Alentejo", "Algarve", d5, t5);
	...
	Servico* serv6 = new Servico("Peniche", "Braga", d6, t6);
	...
	Servico* serv7 = new Servico("Coimbra", "Peniche", d7, t7);
  ...
  */
  ...
  try{
	  ...
	  */
	  ...
	  emp1.adicionaServicoCliente(serv5, 123456);

	  //emp1.adicionaServicoCliente(serv0, 420666);
	  
	  emp1.adicionaServicoCliente(serv1, 420);
	  emp1.adicionaServicoCliente(serv2, 420);
	  emp1.adicionaServicoCliente(serv4, 420);
	  emp1.adicionaServicoCliente(serv3, 420);

	  emp1.adicionaServicoCliente(serv6, 3210);
	  emp1.adicionaServicoCliente(serv7, 3210);
